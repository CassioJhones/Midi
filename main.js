...
demora muito e atrasa a manutenção e escrita do codigo
document.querySelector('.tecla_pom').onclick = tocaSomPom;
toda funcao termina com ();
querySelector funciona apenas com um seletor
 querySelectorAll() funciona com TODOS os elementos com o seletor indicado, SENDO ideal para varios. ou listas
*/
